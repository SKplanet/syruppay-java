...
/**
 * 가맹점에서 사용하기 위한 클라이언트를 설정하고 가맹점에서 시럽페이 서버로의 요청이 가능한 {@link com.skplanet.syruppay.client.SyrupPayClient}를 구성하여 반환한다.
 *
 * @author 임형태
 * @since 0.1
 */
public class SyrupPayClientBuilder {
    public SyrupPayClient build() {
        // TODO 코드 구현
        return null;
    }
}
